...
describe('Business Permit (Amendment)', () => {
    ...
    it.only ('Application submission', ()=> {
        ...
        cy.fixture('BusinessPermit').then((data) => {
            ...
            bp.clickNextAF()
              ...
              bp.setOldBusinessName(data.OldBusinessName)
              bp.setOldBusinessID(data.OldBusinessID)
              bp.setNewBusinessName(data.NewBusinessName)
              bp.setNewBusinessID(data.NewBusinessID)
              
              bp.setOldBusinessAddress(data.OldBusinessAddress)
              bp.setNewBusinessAddress(data.NewBusinessAddress)
              bp.clickNextStep()
